describe 'About Arrays', ->
  ...
  it 'should understand multitype arrays', ->
    multiTypeArray = [0 # newlines substitute for commas in CoffeeScript
                      1
                      'two'
                      -> 3 # anonymous functions can be array elements  - this is a function that returns the value 3
                      value1: 4 # is this one object?   - This is an object with two values in it, so it's in the 4th position in the 0 indexed array
                      value2: 5 # or two objects?
                      [6
                      7]] # This is an array of length two in the 5th position in the zero indexed array.
